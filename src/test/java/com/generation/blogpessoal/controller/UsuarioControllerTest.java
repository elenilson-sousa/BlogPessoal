...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		// configuração da Requisição (Endereço do endPoint , verbo o corpo da
		// requisição
		// a Resposta esperada (Lbjeto da Classe Usuario Persistido no BD)
